...
#ifndef PROJECT_BASE_SMALLBUILDINGROOF_H
#define PROJECT_BASE_SMALLBUILDINGROOF_H
...
class SmallBuildingRoof : public BuildingRoof {
private:
...
public:
    SmallBuildingRoof(glm::vec3 position, float rotateAngle, glm::vec3 additionalTranslate)
...
#endif //PROJECT_BASE_SMALLBUILDINGROOF_H
