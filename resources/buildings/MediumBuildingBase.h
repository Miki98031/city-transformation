...
#ifndef PROJECT_BASE_MEDIUMBUILDINGBASE_H
#define PROJECT_BASE_MEDIUMBUILDINGBASE_H
...
class MediumBuildingBase : public BuildingBase {
private:
...
public:
    MediumBuildingBase(glm::vec3 position, float rotateAngle, glm::vec3 additionalTranslate)
...
#endif //PROJECT_BASE_MEDIUMBUILDINGBASE_H
