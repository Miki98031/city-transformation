...
#ifndef PROJECT_BASE_LARGEBUILDINGROOF_H
#define PROJECT_BASE_LARGEBUILDINGROOF_H
...
class LargeBuildingRoof : public BuildingRoof {
private:
...
public:
    LargeBuildingRoof(glm::vec3 position, float rotateAngle, glm::vec3 additionalTranslate)
...
#endif //PROJECT_BASE_LARGEBUILDINGROOF_H
