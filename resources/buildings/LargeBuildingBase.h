...
#ifndef PROJECT_BASE_LARGEBUILDINGBASE_H
#define PROJECT_BASE_LARGEBUILDINGBASE_H

#include <glm/vec3.hpp>
#include <string>
#include "BuildingBase.h"

class LargeBuildingBase : public BuildingBase {
private:
...
public:
    LargeBuildingBase(glm::vec3 position, float rotateAngle, glm::vec3 additionalTranslate)
...
#endif //PROJECT_BASE_LARGEBUILDINGBASE_H
