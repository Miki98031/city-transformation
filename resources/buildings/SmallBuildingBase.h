...
#ifndef PROJECT_BASE_SMALLBUILDINGBASE_H
#define PROJECT_BASE_SMALLBUILDINGBASE_H
...
class SmallBuildingBase : public BuildingBase {
private:
...
public:
    SmallBuildingBase(glm::vec3 position, float rotateAngle, glm::vec3 additionalTranslate)
...
#endif //PROJECT_BASE_SMALLBUILDINGBASE_H
